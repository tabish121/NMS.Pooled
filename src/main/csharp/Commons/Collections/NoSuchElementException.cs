...
{
    /// <summary>
    /// Exception Thrown from Commons Collections Classes when a requested
    /// item does not exsit in the given collection and the contract says
    ...
    public class NoSuchElementException : Exception
    {
        ...
        public NoSuchElementException(string message, string errorCode) : this(message)
        {
        ...
        public NoSuchElementException(string message, string errorCode, Exception innerException)
