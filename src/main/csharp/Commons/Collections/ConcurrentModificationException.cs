...
namespace Apache.NMS.Pooled.Commons.Collections
{
    ...
    public class ConcurrentModificationException : Exception
    {
        ...
        public ConcurrentModificationException(string message, string errorCode) : this(message)
        {
        ...
        public ConcurrentModificationException(string message, string errorCode, Exception innerException)
        ...
        /// <summary>
        /// Initializes a new instance of the ConcurrentModificationException class with serialized data.
